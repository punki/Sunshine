...
public class WeatherDbHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase sqLiteDatabase) {
        ...
        sqLiteDatabase.execSQL(locationCreateSql);
        sqLiteDatabase.execSQL(weatherCreateSql);
    }

    private String buildLocationCreateSql() {
    ...
    private String buildWeatherCreateSql() {
